...
public class employeeDeductions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/Calculate.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/erase-128.png"))); // NOI18N
        ...
        txt_Save.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/Save-icon.png"))); // NOI18N
    ...
    private void txt_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_SaveActionPerformed
        ...
        if (p == 0) {
            ...
            try {
                ...
                deduct.saveDeduction(new Deductions(txt_firstname.getText(), txt_lastname.getText(), Double.parseDouble(txt_salary.getText()), Double.parseDouble(lbl_total.getText()), Integer.parseInt(txt_id.getText()), value3, txt_reason.getText()));
            ...
            try {
                ...
                audit.saveAduit(new Audit(Integer.parseInt(lbl_emp.getText()), dateString + "/" + timeString, "Updated Deduction Record"));
