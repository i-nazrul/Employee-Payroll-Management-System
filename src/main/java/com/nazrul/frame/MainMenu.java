...
import com.nazrul.dao.DeductionDao;
...
public class MainMenu extends javax.swing.JFrame {
    ...
    DeductionDao did = context.getBean(DeductionDao.class);
SimpleDateFormat sdf;
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/logout.png"))); // NOI18N
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/Payment.png"))); // NOI18N
        ...
        jButton7.setBounds(780, 520, 197, 60);

        jButton3.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/Deduction.png"))); // NOI18N
        ...
        jButton3.setBounds(560, 520, 197, 60);

        jButton2.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/Allowance.png"))); // NOI18N
        ...
        jButton2.setBounds(560, 450, 197, 60);

        add_employee.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        add_employee.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/Add_Employee.png"))); // NOI18N
        ...
        add_employee.setBounds(560, 380, 197, 60);

        jButton4.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/Search.png"))); // NOI18N
        ...
        jButton4.setBounds(780, 380, 197, 60);

        jButton5.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/Update.png"))); // NOI18N
        ...
        jButton5.setBounds(780, 450, 197, 60);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/bk2.jpg"))); // NOI18N
        jPanel2.add(jLabel2);
...
int value = Emp.empId;
                audit.saveAduit(new Audit(value, dateString + "/" + timeString, "Logged out"));
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
       JFileChooser dialog = new JFileChooser();
        ...
        try {
            ...
            List<StaffInformation>slist=sd.getStaff();
          ...
          table.addCell(new PdfPCell(new Paragraph("Present Address",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
          ...
          for(StaffInformation s:slist)
           ...
           table.addCell(new PdfPCell(new Paragraph(s.getId().toString(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getFirstName(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getLastname(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getDob(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getEmail(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getMobile(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getPresentaddress(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getDepartment(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getGender(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(s.getSalary()),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getStatus(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getDateHired(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(s.getJobTitle(),FontFactory.getFont(FontFactory.TIMES_ROMAN,8,Font.PLAIN))));
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        ...
        try {
          ...
          for(Allowance a:alist)
           ...
           table.addCell(new PdfPCell(new Paragraph(a.getId().toString(),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(a.getOvertime()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(a.getMedical()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(a.getBonus()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(a.getOther()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(a.getEmpId()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(a.getSalary()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(a.getRate()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));         
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(a.getTotalAllowance()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(a.getFirstname(),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(a.getLastname(),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        try {
            // TODO add your handling code here:
          List  <Deductions>dlist= did.getDeduction();
         ...
         for(Deductions d:dlist)
            {
           table.addCell(new PdfPCell(new Paragraph(d.getId().toString(),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(d.getFirstname(),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(d.getLastname(),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(d.getSalary()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(d.getDeductionAmount()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(d.getDeductionReason(),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(String.valueOf(d.getEmpId()),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
           table.addCell(new PdfPCell(new Paragraph(d.getMadeBy(),FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.PLAIN))));
