...
public class users extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmd_add.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/Save-icon.png"))); // NOI18N
        cmd_add.setText("Add ");
        ...
        cmd_update.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/update icon.png"))); // NOI18N
    ...
    private void txt_comboPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_txt_comboPopupMenuWillBecomeInvisible
        ...
        for (Users u : ulist) {
            String add1 = u.getUsername();
            txt_username.setText(add1);

            String add2 = u.getPassword();
            txt_password.setText(add2);

            int add3 = u.getId();
            txt_id.setText(String.valueOf(add3));

            String add4 = u.getDivision();
            txt_div.setText(add4);
    ...
    private void cmd_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_updateActionPerformed
        ...
        if (p == 0) {
                        ud.updateUser(new  Users( Integer.parseInt(txt_id.getText()),txt_username.getText(), txt_password.getText(), txt_div.getText()));
                        Fillcombo();
        }
    ...
    private void cmd_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_addActionPerformed
        ...
        if (p == 0) {        // TODO add your handling code here:
            ud.saveUser(new Users(txt_username.getText(), txt_password.getText(),txt_div.getText()));
                Fillcombo();
        }
