...
public class searchEmpSalarySlip extends javax.swing.JFrame {
    ...
    DeductionDao deduct = context.getBean(DeductionDao.class);
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nazrul/images/slip.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (dialogResult == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                double val = 0.00;
                String reason = null;
                List<Deductions> dlist = deduct.searchDeduction(Integer.parseInt(value1));
                for (Deductions d : dlist) {
                    val = val+d.getDeductionAmount();
                    reason = d.getDeductionReason();
              ...
              double bonus = 0.00;
                ...
                List<Allowance> alist = ad.searchAllowance(Integer.parseInt(value1));
                for (Allowance a : alist) {
                    allowance =allowance+ a.getTotalAllowance();
                    bonus = bonus+a.getBonus();
                    medical = medical+a.getMedical();
                    other =other+ a.getOther();
                    overtime = overtime+a.getOvertime();
                }

                double calcTotal = Double.parseDouble(txt_salary.getText());
                double x = allowance;
                ...
                myDocument.add(new Paragraph("Basic Salary: TK" + calcTotal, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                myDocument.add(new Paragraph("Overtime: " + overtime + " Hours", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                myDocument.add(new Paragraph("Medical: TK" + medical, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                myDocument.add(new Paragraph("Bonus: TK" + bonus, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                myDocument.add(new Paragraph("Other: TK" + other, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
                ...
                myDocument.add(new Paragraph("Total Deductions : TK" + val, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
                myDocument.add(new Paragraph("TOTAL PAYMENT", FontFactory.getFont(FontFactory.TIMES_ROMAN, 15, Font.BOLD)));
                myDocument.add(new Paragraph("Total Earnings: " + allowance, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
